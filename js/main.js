$(document).ready(function(){
  ...
  setInterval(function(){
    ...
    $('#img').html('<img id="img-chaochi" class="animate__animated animate__flash img-chaochi" src="img/chaochi-'+i+'.png" alt=""><img class="animate__animated animate__pulse img-bg" src="img/bg-'+i+'.png" alt="">')
    i++;
  },8000); 
})
...
function switchColor() {
  ...
  setStyle(document.querySelector('#dvd'), {
    color: colors[color]
  });
